    ...
    <CRPMThemeContext.Provider value={value}>
      <div
        ...
        className="
          ...
          data-[crpm-theme=light]:[--crpm-soft:#e2e8f0]
          data-[crpm-theme=light]:[--crpm-cell:#f8fafc]
          data-[crpm-theme=light]:[--crpm-border:#94a3b8]
          data-[crpm-theme=light]:[--crpm-text:#0f172a]
          data-[crpm-theme=light]:[--crpm-muted:#1e293b]
          data-[crpm-theme=light]:[--crpm-faint:#475569]
          data-[crpm-theme=light]:[--crpm-heading:#020617]
          data-[crpm-theme=light]:[--crpm-green:#047857]
          data-[crpm-theme=light]:[--crpm-red:#b91c1c]
          data-[crpm-theme=light]:[--crpm-blue:#0369a1]
